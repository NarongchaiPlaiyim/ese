...
//        sqlReport.append(" AND ").append(getPrefix()).append(".location_qty.location_id = ").append(getPrefix()).append(".location_items.location_id");
        ...
        sqlReport.append(" ON ").append(getPrefix()).append(".inv_onhand.item_id = ").append(getPrefix()).append(".location_qty.item_master_id ");//jowjo
...
//        sqlReport.append(" AND ").append(getPrefix()).append(".inv_onhand.item_id = ").append(getPrefix()).append(".location_qty.item_master_id ");
